  ...
  <div class="m-stencli-container">
      <div class="m-stencli-header">
        ...
        <div class="m-stencli-info">
          <span class="m-stencli-info-label">交易哈希：</span>
          <span class="m-stencli-info-res">{{message.txHash}}</span>
        </div>
      </div>
      <div class="m-stencli-main">
        <div class="m-stencli-info">
          <span class="m-stencli-info-label">所在区块：</span>
          <span class="m-stencli-info-desc">{{message.blockHeight}}</span>
        </div>
        <div class="m-stencli-info">
          <span class="m-stencli-info-label">交易额：</span>
          <span class="m-stencli-info-desc">{{message.transactionFee}}&nbsp;{{message.coinType}}</span>
        </div>
        <div class="m-stencli-info">
          <span class="m-stencli-info-label">交易费：</span>
          <span class="m-stencli-info-desc">{{message.totalIncome}}&nbsp;{{message.coinType | danWei}}</span>
        </div>
        <div class="m-stencli-info">
          <span class="m-stencli-info-label">确认次数：</span>
          <span class="m-stencli-info-desc">{{[message.confirmNum,message.coinType] | filterTol}}</span>
        </div>
        <div class="m-stencli-info">
