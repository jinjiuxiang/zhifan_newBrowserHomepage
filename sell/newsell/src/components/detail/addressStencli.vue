  ...
  <div class="pc-stencli-container">
      <div class="pc-stencli-header">
        ...
        <div class="pc-stencli-header-right">
          <span class="pc-stencli-label" style="color: #333333">{{$t('message.address')}}：</span>
          <span class="pc-stencli-text">{{message.addressHash}}</span>
        </div>
      </div>
      <div class="pc-stencli-main">
        <div class="pc-stencli-main-left">
          <div class="pc-stencli-main-box">
            <span class="pc-stencli-label">{{$t('message.totalRevenue')}}：</span>
            <span class="pc-stencli-text">{{message.totalIncome}}&nbsp;{{message.coinType}}</span>
          </div>
          <div class="pc-stencli-main-box">
            <span class="pc-stencli-label">{{$t('message.balance')}}：</span>
            <span class="pc-stencli-text">{{message.balance}}&nbsp;{{message.coinType}}</span>
          </div>
        </div>
        <div class="pc-stencli-main-right">
          <div class="pc-stencli-main-box">
            <span class="pc-stencli-label">{{$t('message.totalTransactions')}}：</span>
            <span class="pc-stencli-text">{{message.totalTxNum}}&nbsp;{{$t('message.frequency')}}</span>
          </div>
          <div class="pc-stencli-main-box">
            <span class="pc-stencli-label">{{$t('message.latestTransaction')}}：</span>
            <span class="pc-stencli-text"><span :class="addORReduce(message.lastTx)">{{message.lastTx | filterNum}}</span>&nbsp;{{message.coinType}}/{{message.lastTxTime | timeFilter}}</span>
          </div>
        </div>
      </div>
